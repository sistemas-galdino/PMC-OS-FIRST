...
const ROTAS_ADMIN: Destino[] = [
  ...
  { label: "Meu Dia", url: "/crm/meu-dia", grupo: "CRM" },
  { label: "Atividades", url: "/crm/atividades", grupo: "CRM" },
  { label: "Clientes (CRM)", url: "/crm/clientes", grupo: "CRM" },
  { label: "Alertas", url: "/crm/alertas", grupo: "CRM" },
  { label: "Atendimento", url: "/crm/atendimento", grupo: "CRM" },
  { label: "Projetos & Gargalos", url: "/crm/projetos", grupo: "CRM" },
  { label: "Visão Geral (CRM)", url: "/crm/visao-geral", grupo: "CRM" },
  { label: "Torre de Comando", url: "/crm/time", grupo: "CRM" },
  { label: "Acompanhamento do Time", url: "/crm/acompanhamento", grupo: "CRM" },
  { label: "Manual de CS", url: "/crm/manual", grupo: "CRM" },
  ...
  { label: "Repositório de Vitórias", url: "/repositorio-vitorias", grupo: "Vitórias dos Clientes" },
  { label: "Vitrine", url: "/vitrine", grupo: "Vitórias dos Clientes" },
  { label: "Cases", url: "/vitrine-cases", grupo: "Vitórias dos Clientes" },
  { label: "Logos & Clientes", url: "/vitrine-clientes", grupo: "Vitórias dos Clientes" },
  { label: "Evidências", url: "/vitrine-evidencias", grupo: "Vitórias dos Clientes" },
  { label: "Oportunidades", url: "/vitrine-oportunidades", grupo: "Vitórias dos Clientes" },
